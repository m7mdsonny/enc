...
<head>
    <meta charset="utf-8">
    <title>Partner Banner Control</title>
    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Partner Banner Control</h1>
            </div>
        </div>
    </div>
...
<input type="file" id="file_Client_img" style="display:inline;" accept="image/png, image/jpe, image/jpeg,image/jpg,image/gif"/>
</td>
</tr>
</table>
            <div class="col-lg-12">
		...
		<?php
				...
				$selectFeaturesIntro=mysqli_query($conn,"select * from banner where banner_group='ClientBanner'");
                ...
                <div style="display:inline;">
                    ...
                    <div class=" position-relative overflow-hidden bg-secondary d-flex" style="display:inline;">
                        <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center text-white px-4 txtforBack w-15" >
							<span><a class="btn btn-success DeleteClientBanner" href="#" id="<?php echo $banner_id;?>">Delete</a></span>
                        </div>
                    </div>
                </div>
				<?php
