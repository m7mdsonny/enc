...
$.post("@inc/data.php?status=register",{username:username,email:email,password:password},function(data){
if(data==1){
...
$.post("@inc/data.php?status=Login",{emailLog:emailLog,passwordLog:passwordLog},function(data){
    if(data == 0){
