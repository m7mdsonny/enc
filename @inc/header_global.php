...
<div class="navbar navbar-expand-lg navbar-light bg-dark">
  ...
  <img src="img/logo.png" width="100" height="50"/>
      ...
      <a class="nav-item nav-link text-white" href="partner.php">Partner</a>
      <a class="nav-item nav-link active" href="globalreach.php">Global Reach<span class="sr-only">(current)</span></a>
