    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Slideshow Control</h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="blog-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo $slide_img;?>" alt="">
                    </div>
                    <div class=" position-relative overflow-hidden bg-secondary d-flex">
                        <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center text-white px-4 txtforBack w-100" >
                            <span><?php echo $slide_id;?></span>
                            <h5 class="text-uppercase m-0"><?php echo $slide_title;?></h5>
                            <span><?php echo $slide_caption;?></span>
							<span><a class="btn btn-success DeleteSlideshow" href="#" id="<?php echo $slide_id;?>">Delete</a></span>
                        </div>
                    </div>
                </div>
            </div>
