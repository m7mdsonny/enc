    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Quote Message</h1>
            </div>
        </div>
    </div>
...
<?php
$messid=$_GET['mid'];
$updatemessage=mysqli_query($conn,"UPDATE quote SET reading='1' WHERE quote_id=$messid");
$mysqlSelectquote=mysqli_query($conn,"select * from quote where quote_id=$messid");
$fetchQuote=mysqli_fetch_assoc($mysqlSelectquote);
